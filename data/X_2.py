...
for p in P:
    for r_c in r_c_arr:
        for f_c in f_c_arr:
            for t in t_arr:
                M = np.load("./graph/set_2/D_" + str(int(p)) + "/T_" + str(int(t)) + "_r_" + str(r_c) + "_f_" + str(f_c) + ".npy", allow_pickle=True)
                ...
                np.save("X/set_2/D_" + str(int(p)) + "/X_" + str(int(t)) + "_r_" + str(r_c) + "_f_" + str(f_c) + ".npy", X_data, allow_pickle=True)
